...
没有抓到微信CK的也可以跑脚本，删掉wzq_qlskey和wzq_qluin就行，会尝试用APP的CK去完成微信任务，出现做任务失败是正常现象

青龙抓包，需要抓APP和公众号里面的小程序
1. wzq.tenpay.com 把url里的openid和fskey用&连起来填到TxStockCookie
2. 公众号 腾讯自选股微信版->右下角好福利->福利中心，wzq.tenpay.com 把Cookie里的wzq_qlskey和wzq_qluin用&连起来填到TxStockCookie
格式如下：
...
[task_local]
#腾讯自选股
35 11,16 * * * https://raw.githubusercontent.com/shadiaow/script/main/txzxg.js, tag=腾讯自选股, enabled=true
[rewrite_local]
https://wzq.tenpay.com/cgi-bin/.*user.*.fcgi url script-request-header https://raw.githubusercontent.com/shadiaow/script/main/txzxg.js
[MITM]
